...
const page = () => {
  ...
  return (
    <div className="pagecontent gridpagecontent innerpagegrid mobileview withdrawmobileview">
      <div className="mbheadingbox p-3">
        ...
        <div className='flex-one-cls'>
          <h2 className="heading-title text-center p-0 m-0">Withdraw</h2>
        </div>
            ...
            <div className="mt-0 panelcontentbox border-0">
              <Form className="siteformbg">
                ...
                <div>
                  <Form.Group className="form-group">
                    ...
                    <InputGroup>
                      ...
                      <InputGroup.Text id="copy" className="cpybtn">   <Image
                        src="/assets/images/content_copy.svg"
                        width={50}
                        height={50}
                        alt="coin"
                        className="coinicon m-0 coinicon-copymobile"
                      /></InputGroup.Text>
                    </InputGroup>
                  </Form.Group>
                </div>
                <div>
                  ...
                  <Form.Group className="form-group">
                    <Button type="submit" className="sitebtn btn-block" id="withdrawsubmit">Submit</Button>
                  </Form.Group>
