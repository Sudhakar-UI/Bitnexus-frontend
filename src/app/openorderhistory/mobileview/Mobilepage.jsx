...
const page = () => {
    ...
    return (
        <>
            <div className="pagecontent gridpagecontent innerpagegrid mobileview deposithismobileview openorderhistorymobileview">
                    ...
                    <Container className="container sitecontainer historypage">
                        <div className="innerpagecontent d-flex align-items-center gap-2">
                            <Form.Group className="form-group w-100 mb-0">
                                ...
                                >
                                    <option value="/open-order-history">Open Order History</option>
                                    <option value="/deposithistory">Deposit History</option>
                                    <option value="/openorderhistory">Withdraw History</option>
