...
import { faTimes, faL, faSortDown, faArrowUp, faArrowLeft, faStar } from '@fortawesome/free-solid-svg-icons';
...
export const page = () => {
    ...
    return (
        <div className="livepricelist mobilebg p-2 trade-bg-white">
                    ...
                    <div className='d-flex justify-content-start align-items-center gap-1'>
                        <div>
                            <button onClick={setShowModal1} className='d-flex justify-content-start align-items-center gap-1 bg-none border-0 px-0'>
                                <FontAwesomeIcon className='pe-2 faStar-icon' icon={faStar} /> <Image className='trade-coin-icon' src="./assets/images/color/btc.svg"></Image>
            ...
            <Modal
                show={showModal1}
                onHide={handleClose1}
                className="modalbgt nummodal mobileview-md tradelive-pricelist-mobile"
                                            ...
                                            <tr className='activerow'>
                                                <td>
                                                    <div className="d-flex justify-content-between">
                                                        ...
                                                        <FontAwesomeIcon className='faStar-icon active text-end' icon={faStar} />
                                                    </div>
                                                </td>
                                                <td className="text-start liveprice-td">
                                                    <div className="d-flex justify-content-between align-items-center">
                                            ...
                                            <tr className='activerow'>
                                                <td>
                                                    <div className="d-flex justify-content-between">
                                                        ...
                                                        <FontAwesomeIcon className='faStar-icon text-end' icon={faStar} /></div>
                                            ...
                                            <tr className='activerow'>
                                                <td>
                                                    <div className="d-flex justify-content-between">
                                                        ...
                                                        <FontAwesomeIcon className='faStar-icon  text-end' icon={faStar} />
                                                    </div>
                                                </td>
                                                <td className="text-start liveprice-td">
                                                    <div className="d-flex justify-content-between align-items-center">
