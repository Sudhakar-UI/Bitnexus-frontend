...
import { faSortDown, faTimesCircle, faAngleRight, faEyeSlash, faCircleInfo, faLongArrowRight, faArrowLeft, faBars } from '@fortawesome/free-solid-svg-icons';
...
const page = () => {
    ...
    return (
        <div className="pagecontent gridpagecontent innerpagegrid mobileview mobile-profile mobiletradepage">
            ...
            <div className="mbheadingbox p-3">
                ...
                <div className='flex-one-cls'>
                    <h2 className="heading-title text-center p-0 m-0">Profile</h2>
                </div>
            ...
            <article className="gridparentbox pt-0">
                <Container className="sitecontainer profilepage">
                    <div className="introbox panelcontentbox mb-1">
                        <div className="cryptobox">
                            <div className="profilebox">
                                <div className='d-flex gap-3 w-100 align-items-center bottom-border-mobile'>
                                    <div>
                                    ...
                                    <h3 className="h5"> Set Nickname <Link href="#" id="editprofile" className="t-gray ms-2 edit-img-icon-x" onClick={handleShow1}><Image src="assets/images/edit.svg" width={20} height={20} alt="icon" /></Link></h3>
                                </div>
                                <div>
                    ...
                    <div className="flexbox securpanelbox">
                        <div>
                            <div className="overviewbalancebox panelcontentbox mb-1">
                                <div className="table-content">
                                    <div>
                                        <h2 className="subhead text-start">Total Balance <FontAwesomeIcon icon={faEyeSlash} /></h2>
                                        <div className="d-flex  justify-content-start cry-content">
                                    ...
                                    <div className="text-end dwt-btn d-flex  justify-content-between gap-3 total-balance-bty-y">
                            ...
                            <div className="panelcontentbox mb-1">
                            ...
                            <div className="panelcontentbox stckbox mb-1">
