...
import { faCheckCircle, faClose, faEye, faEyeSlash, faTimesCircle, } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className='innerpagetab boxtabb'>
                        ...
                        <div className="securitypage">
                            <div className="securityinnerbox panelcontentbox mt-0">
                                <div className="">
                                    <div>
                                        <h2 className="subhead pb-2 mb-2 pt-0">Basic Security Settings</h2> 
                                        <h4 className="sec-header">Two-Factor Authentication (2FA)</h4>
                                        ...
                                        <div className="securityalert">
                                            <div className="d-flex gap-0">
                                                <div>
                                                    <p className="mb-0">Security Level : <span className="t-red">Low</span>
                                    ...
                                    <div className="faverifybox pt-2">
                                        <div className="profiletablebox contentbox">
                                            ...
                                            <div>
                                                ...
                                                <h5 className="t-gray">Add an extra BitNexus of security using Google Authenticator for withdrawals and security actions.</h5>
                                            </div>
                                        ...
                                        <hr />
                                        <div className="profiletablebox contentbox">
                                            <div> <Image src="assets/images/email.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                            <div>
                            ...
                            <div className="securityinnerbox mt-3 panelcontentbox">
                                ...
                                <div className="faverifybox">
                                    <div className="profiletablebox contentbox">
                                        <div> <Image src="assets/images/anticode.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                        <div>
                                            <h4>Anti-Phishing Code</h4>
                                            <h5 className="t-gray">Create a personalized code that will appear in all BitNexus emails to protect you from phishing attempts.</h5>
                                        </div>
                                        <div className="text-center statusdivbox">
                                    ...
                                    <hr />
                                    <div className="profiletablebox contentbox">
                                        <div> <Image src="assets/images/login-password.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                        <div>
                            ...
                            <div className="securityinnerbox mt-3 panelcontentbox">
                                ...
                                <div className="faverifybox">
                                    <div className="profiletablebox contentbox">
                                        <div> <Image src="assets/images/account-activities.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                        <div>
                                    ...
                                    <hr />
                                    <div className="profiletablebox contentbox">
                                        <div> <Image src="assets/images/device.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                        <div>
                                            <h4>Device Management</h4>
                                            <h5 className="t-gray">Manage and remove devices that have access to your BitNexus account.</h5>
                                        </div>
                                        <div> <Link id="deviceauth" className="sitebtn btn-sm graybtn" href="/devicemanagement">Manage</Link></div>
                                    </div>
                                    <hr />
                                    <div className="profiletablebox contentbox">
                                        <div> <Image src="assets/images/delete.svg" width={50} height={50} alt="icon" className="securityiconbox" /> </div>
                                        <div>
                                            <h4>Delete Account</h4>
                                            <h5 className="t-gray">Permanently delete your BitNexus account. Once deleted, it cannot be recovered, and all services will become inaccessible.</h5>
                                        </div>
                                        <div>
