...
const page = () => {
  ...
  return (
    <div className="affiliate-page affiliate-page-mo ">
      {/* <Homeheader /> */}
          ...
          <Row className="homealign-items-center row-gap-3">
            <Col lg={6} md={6} sm={12} className="d-flex align-items-start flex-column p-3 pb-4">
              ...
              <p className="text-start">
                Join our affiliate program and earn recurring commissions by <br />
                introducing users to a secure, high-liquidity crypto platform.
              </p>
              <Button href="/affiliate-form" className="sitebtn mt-3 text-start">Get Started Now</Button>
            </Col>
      ...
      <section className="affiliate-benefits">
        <Container>
          ...
          <div className="d-flex align-items-start gap-2">
            <Image
              className="how-affiliate-works-img-X"
              src="assets/images/steps.svg"
              height={50}
              width={50}
            ></Image>

            <div className="how-tt-flex flex-fill">
              <div>
                <div>
