...
import Homefootermobile from "../../components/Footermenu-mobile";
...
const page = () => {
    ...
    return (
        <>
            <article className="affiliate-form-page-align gridparentbox innerpage other-pages mobileview mobiletradepage">
                {/* <Homeheader /> */}
                <div className="mbheadingbox p-3">
                    ...
                    <div className='flex-one-cls'>
                        <h2 className="heading-title text-center p-0 m-0">Affiliate Program</h2>
                    </div>
                ...
                <div className="innerpages ">
                    <Container>
                        <div className="gridparentbox affiliate-form-page panelcontentbox">
                            <h2 className="heading-title pb-3 text-center pb-0">
                                Join the Bitnexus Affiliate Program
                            </h2>
                            <div className="content mb-0 affiliate-p ">
                                <p>  The Bitnexus Affiliate Program is open to users with active social media accounts, including YouTube, Instagram, Facebook, Twitter, and Telegram.
                                </p>
                                <p>
                                    Please fill out the application form. If you meet the requirements, we will contact you.
                                    For more details, please check the Bitnexus Affiliate Program Guide. </p>
                                <span>
                        ...
                        <div className="row">
                            <div className="col-lg-12 mx-auto  mb-3">
                                {/* STEP BAR */}
                                <div className="steps-wrapper my-3">
                                    {/* STEP 1 */}
                                            ...
                                            <form className="aff-form-form">
                                                <div className="logcenterbox siteformbg ">
                                                    ...
                                                    <Form.Group className="form-group">
                                                        ...
                                                        <div className="affi-social-forms othersocials mt-1">
                                                ...
                                                <div className="d-flex gap-3 aff-next-btn-border gap-2">
                                                    <button className="btn sitebtn w-100 mb-sm-x">Reset</button>
                                                    <button
                                                        type="button"
